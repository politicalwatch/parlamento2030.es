<template>
  <div>
    <div id="footprint" class="o-container o-section u-margin-bottom-10">
      <tipi-header title="Huella parlamentaria" />
      <div class="o-grid">
        <div class="o-grid__col u-12 u-8@sm">
          ...
          <p>
            ...
            en los diferentes
            <router-link :to="{ name: 'ods' }">ODS</router-link> a los que da
            seguimiento Parlamento 2030.
          </p>
          <p>
          ...
          <div class="example">
            ...
            <p>
              ...
              Huella parlamentaria de 191 tras haber presentado las siguientes
              iniciativas:
            </p>
            <ul>
          ...
          <div class="example">
            <h5 class="u-uppercase">Ejemplo</h5>
            <p>
              La huella de la diputada anterior ascendería a 351 si tuviera
          ...
          <div class="example">
            ...
            <p>
              ...
              su Huella parlamentaria pasaría de 351 a 263.25.
            </p>
          </div>
        </div>
      </div>
